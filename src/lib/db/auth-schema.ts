 ...
 * Tên cột (JS key) phải khớp field name của Better Auth (camelCase) để
 * drizzleAdapter map đúng; tên cột DB dùng snake_case theo convention dự án.
 * id dạng text vì Better Auth tự sinh chuỗi id.
 */
